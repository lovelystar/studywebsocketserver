...
public class WebSocketFilterSecurityMetaSource  implements FilterInvocationSecurityMetadataSource {
	...
	*/
	...
	public void loadResource() throws Exception {
		...
		// 임시 데이터 세팅
		OAuthResourceAuthorityVo tmpVo = new OAuthResourceAuthorityVo();
		tmpVo.setUserName("SUMIN");
		tmpVo.setAuthority("ROLE_SUMIN");
		tmpVo.setResourceId("TEMP_RESOURCE_ID");
		tmpVo.setResourceName("TEMP_RESOURCE_NAME");
		tmpVo.setResourcePattern("TEMP_RESOURCE_PATTERN");
		tmpVo.setResourceType("TEMP_RESOURCE_TYPE");
		tmpVo.setHttpMethod("TEMP_HTTP_METHOD");
		resourceAuthorityVoList.add(tmpVo);
